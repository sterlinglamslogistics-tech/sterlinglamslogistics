  ...
  return (
    <div className="mx-auto max-w-md px-4 pb-8">
      <div className="sticky top-0 z-40 flex items-center gap-3 bg-background py-3">
        ...
        <h1 className="text-lg font-bold">Waiting</h1>
      </div>

      <div className="flex flex-col items-center justify-center py-20">
        <Clock className="mb-3 h-12 w-12 text-muted-foreground/30" />
        <p className="text-sm text-muted-foreground">No waiting orders</p>
        <p className="text-xs text-muted-foreground">Orders awaiting pickup will appear here</p>
      </div>
    </div>
  )
}
