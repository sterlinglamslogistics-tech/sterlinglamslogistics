...
export default function DispatchPage() {
  ...
  return (
    <div className="grid h-[calc(100vh-3.5rem)] gap-0 overflow-hidden lg:grid-cols-[380px_minmax(0,1fr)]">
      {/* ═══ Sidebar ═══ */}
      <aside className="hidden lg:flex h-full min-h-0 flex-col border-r bg-card">
        {/* header */}
